(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
  ...
  {
    otherChunks: [
      'static/chunks/0-muvt99~4h~k.js',
      'static/chunks/13lhlucecwcoq.js',
      'static/chunks/0aiv_uu_~f.ba.js',
    ],
    runtimeModuleIds: [30381],
  },
]),
  (() => {
    let e;
    ...
    const b = Object.getPrototypeOf ? (e) => Object.getPrototypeOf(e) : (e) => e.__proto__,
      y = [null, b({}), b([]), b(b)];
    function g(e, t, r) {
      let n = [],
        o = -1;
    ...
    s.a = function (e, t) {
      const r = this.m,
        ...
        o = new Set(),
        { resolve: l, reject: i, promise: u } = k(),
        s = Object.assign(u, {
          [v]: r.exports,
          [j]: (e) => {
      ...
      Object.defineProperty(r, 'exports', a),
        ...
        e(
          (e) => {
            ...
            return t.map((e) => e[j](s)), u.queueCount ? l : r();
          },
          (e) => {
            e ? i((s[C] = e)) : l(s[v]), P(n);
          },
    ...
    async function T(e, t, r) {
      ...
      if (u.length > 0) {
        ...
        const r = new Set();
        for (const e of i) E.has(e) || r.add(e);
        for (const n of r) {
          const r = M(e, t, N(n));
          E.set(n, r), u.push(r);
        }
        ...
        for (const o of ((n = M(e, t, N(r.path))), i)) E.has(o) || E.set(o, n);
      }
    ...
    (R.L = function (e) {
      ...
      (R.b = (e, t, o, l) => {
        const i = 'SharedWorker' === e.name,
          u = [o.map((e) => N(e)).reverse(), r];
        for (const e of n) u.push(globalThis[e]);
        const s = new URL(N(t), location.origin),
          a = JSON.stringify(u);
        return (
          i ? s.searchParams.set('params', a) : (s.hash = '#params=' + encodeURIComponent(a)),
    ...
    e = {
      async registerChunk(e, r) {
        ...
        if ((D('string' == typeof e ? N(e) : e.src).resolve(), null != r)) {
          for (const e of r.otherChunks) D(N('string' == typeof e ? e : e.path));
          if (
